...
export async function updateStats(token, {favourited, userId, watched, videoId}){
  ...
  const response = await queryHasuraGQL(
    operationsDoc, 'updateStats', { favourited, userId, watched, videoId }, token
  );
...
export async function insertStats(token, {favourited, userId, watched, videoId}){
  ...
  const response = await queryHasuraGQL(
    operationsDoc, 'insertStats', { favourited, userId, watched, videoId }, token
  );

  return response;
}

export async function findVideoIdByUser(videoId, userId, token){
  const operationsDoc = `
